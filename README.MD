# DataRouter_backend 数由管理后台v1.0

基于 React +Redux+ Antd 开发。
...
node_modules                        
mock 
|-- index.js                        # json-server(mock)模拟数据
polyfill                            # polyfill打包文件（IE8兼容包）
src                                 # 项目源码
|-- assets                          # 静态资源，包括公用的 css/less/html/images 等
|-- action                          # redux-action 集中营
|-- reducers                        # redux-reducer 集中营
|-- store                           # redux 数据仓                       
